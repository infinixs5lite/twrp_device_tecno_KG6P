...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := TECNO-KG6P
...
TARGET_KERNEL_CONFIG := TECNO-KG6P_defconfig
TARGET_KERNEL_SOURCE := kernel/tecno/TECNO-KG6P
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 36554432
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 36554432
